...
<div className="about">
  ...
  <div className="timeline">
      ...
      <Block width="745px" height="360px" className="aboutblock left">
      ...
      <div className="timeline-marker right" style={{ top: '183px' }}/>

      <Block width="745px" height="300px" className="aboutblock right">
        <h1 className='abouttext1'>Education</h1>
        <h2 className='abouttext2'>I graduated in 2026 as a Computer Science Engineer from Óbuda University (John von Neumann Faculty of Informatics), specializing in Software Design and Development. 
      ...
      <div className="timeline-marker left" style={{ top: '595px' }}/>
      
      <Block width="745px" height="230px" className="aboutblock left">
      ...
      <div className="timeline-marker right" style={{ top: '935px' }}/>

      <Block width="745px" height="350px" className="aboutblock right">
      ...
      <div className="timeline-marker left" style={{ top: '1285px' }}/>

      <Block width="745px" height="380px" className="aboutblock left">
      ...
      <div className="timeline-marker right" style={{ top: '1660px' }}/>
